<?php
// HTTP
define('HTTP_SERVER', 'http://localstore.loc:8080/');

// HTTPS
define('HTTPS_SERVER', 'http://localstore.loc:8080/');

// DIR
define('DIR_APPLICATION', '/media/f/PROGRAMMING/WordPress/opencart/opencartstore/catalog/');
